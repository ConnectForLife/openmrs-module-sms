...
import org.connectforlife.module.sms.api.web.GridSettings;
import org.connectforlife.module.sms.api.web.dto.SmsRecordsPageable;
import org.connectforlife.module.sms.domain.PagingInfo;
...
public class SmsRecordController extends RestController {
    ...
    @ResponseBody
    public SmsRecordsPageable getAll(@ApiParam(name = "gridSettings", value =
