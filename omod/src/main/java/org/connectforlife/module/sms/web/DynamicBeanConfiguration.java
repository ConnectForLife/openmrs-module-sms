...
package org.connectforlife.module.sms.web;
...
@Configuration("sms.dynamicBeanConfiguration")
...
public class DynamicBeanConfiguration {
  ...
  public AbstractHandlerExceptionResolver getHandlerExceptionResolver() throws Exception {
    ...
    HttpMessageConverter<?> stringHttpMessageConverter = Context.getRegisteredComponent(
        "smsStringConverter", HttpMessageConverter.class);

    HttpMessageConverter<?> jsonHttpMessageConverter = Context.getRegisteredComponent("smsJsonConverter",
