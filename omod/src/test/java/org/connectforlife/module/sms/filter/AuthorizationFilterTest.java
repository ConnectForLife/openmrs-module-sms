...
package org.connectforlife.module.sms.filter;
...
import org.connectforlife.module.sms.model.SmsHttpRequest;
...
public class AuthorizationFilterTest {
    ...
    public void doFilterReturnForbiddenWhenSessionInvalid() throws IOException, ServletException {
        ...
        ServletRequest request = new SmsHttpRequest()
    ...
    @Test
    public void doFilterHandleOtherExceptionsSuccessfully() throws Exception {
        doThrow(new APIException()).when(Context.class, "authenticate",
                Mockito.any(String.class), Mockito.any(String.class));
        FilterChain filterChain = new MockFilterChain();
        ServletRequest request = new SmsHttpRequest()
                .setValidSessionId(true)
